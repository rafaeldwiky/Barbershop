...
if (isset($_POST['simpan_layanan'])) {
    ...
    $query = "INSERT INTO layanan (id_layanan, nama_layanan, deskripsi_layanan, harga_layanan) VALUES ('$id_layanan','$nama_layanan','$deskripsi_layanan','$harga_layanan')";
    ...
    if ($query_run) {
        ...
        $res = [
            'status' => 500,
            'message' => 'layanan gagal ditambah: ' . mysqli_error($koneksi)
        ];
        echo json_encode($res);
        return;
    }
