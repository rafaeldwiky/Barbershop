                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <img src="img/logo/logofixsbgt.png" alt="">
                            </div>
                        </div>
                        <div class="col-xl-10 col-lg-10 col-md-10">
                            <div class="menu-main d-flex align-items-center justify-content-end">
                                ...
                                <div class="header-right-btn f-right d-none d-lg-block ml-30">
                                    <a href="../auth/login.php" class="btn header-btn">Booking</a>
                                </div>
                            </div>
                        </div>
                        <!-- Mobile Menu -->
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-11">
                        <!-- about-img -->
                        <div class="about-img ">
                            <img src="img/logo/profile.jpg" alt="">
                        </div>
                    </div>
        ...
        <div class="best-pricing section-padding2 position-relative">
            ...
            <div class="pricing-img">
                <img class="pricing-img1" src="img/logo/main1.jpg" alt="">
                <img class="pricing-img2" src="img/gallery/pricing2.png" alt="">
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(img/logo/photo1.heic);">
                            </div>
                    ...
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(img/logo/photo2.webp);">
                            </div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(img/logo/photo\ 6.jpg);">
                            </div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(img/logo/photo4.heic);">
                            </div>
                            <div class="overlay"></div>
                        </div>
                    </div>
    ...
    <footer>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-7 col-md-9 col-sm-10">
                <div class="section-tittle text-center mb-100">
                    <h1>Contact Kami</h1>
                    <img src="img/logo/logofixsbgt.png">
                </div>
            </div>
        </div>
