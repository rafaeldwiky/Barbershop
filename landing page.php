...
<body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assetss/img/logo/loder.png" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.html"><img src="assetss/img/logo/LOGOO1.png" alt=""></a>
                            </div>
                        </div>
    ...
    <main>
        ...
        <section class="about-area section-padding30 position-relative">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-11">
                        <!-- about-img -->
                        <div class="about-img ">
                            <img src="assetss/img/logo/profile.png" alt="">
                        </div>
                    </div>
            ...
            <div class="about-shape">
                <img src="assetss/img/gallery/about-shape.png" alt="">
            </div>
        </section>
        <!-- About-2 Area End -->
        <!--? Services Area Start -->
        ...
        <div class="best-pricing section-padding2 position-relative">
            ...
            <div class="pricing-img">
                <img class="pricing-img1" src="assetss/img/logo/main1.jpg" alt="">
                <img class="pricing-img2" src="assetss/img/gallery/pricing2.png" alt="">
            </div>
        </div>
        ...
        <div class="gallery-area section-padding30">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(assetss/img/logo/photo3.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="assetss/img/gallery/home-blog1.png" alt="">
                                    <!-- Blog date -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="assetss/img/gallery/home-blog2.png" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
                                        <p>Now</p>
    ...
    <footer>
        <!--? Footer Start-->
        <div class="footer-area section-bg" data-background="assetss/img/gallery/footer_bg.png">
            <div class="container">
